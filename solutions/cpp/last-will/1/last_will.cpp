...
{
    [[nodiscard]] int assemble_account_number(const int secret_modifier)
    {
    ...
    [[nodiscard]] int assemble_code()
    {
        const auto blue_sum = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
        const auto red_sum = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
