...
[[nodiscard]] static constexpr bool can_eat_ghost(const bool power_pellet_active, const bool touching_ghost) {
...
// dot.
[[nodiscard]] static constexpr bool scored(const bool touching_power_pellet, const bool touching_dot) {
...
[[nodiscard]] static constexpr bool lost(const bool power_pellet_active, const bool touching_ghost) {
...
[[nodiscard]] static constexpr bool won(const bool has_eaten_all_dots, const bool power_pellet_active, const bool touching_ghost) {
